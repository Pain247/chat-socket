...
connection.query("create table messages ( userid int not null, message varchar(10000),times timestamp primary key not null,constraint KEY_1 foreign key (userid) references users(userid))");
